...
- URL: https://huggingface.co/spaces/Chris4K/Kali-Linux-Bleeding-Edge-MCP-Server
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/Kali-Linux-Bleeding-Edge-MCP-Server/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/Kali-Linux-Bleeding-Edge-MCP-Server
